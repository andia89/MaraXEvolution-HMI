...
| **Threaded Inserts** | [M3 Threaded Inserts](https://www.ruthex.de/en/products/ruthex-gewindeeinsatz-m3-100-stuck-rx-m3x5-7-messing-gewindebuchsen) | ~4-6 | Standard heat-set inserts (e.g., Ruthex M3x5.7). Any should do|
