...
num_copies = 47 - 10                    # How many rectangles to create
...
for j in range(num_copies + 1):
    ...
    output_svg_filename = f'pictures/triangle_{j}.svg'
    output_png_filename = f'pictures/triangle_{j}.png'
    ...
    for i in range(num_copies):
        ...
        path = "m 255.66992,13.902344 a 3.5980847,3.5980847 0 0 0 -3.11523,5.396484 l 2.16406,3.75 2.16602,3.75 a 3.5980847,3.5980847 0 0 0 6.23046,0 l 2.16602,-3.75 2.16406,-3.75 a 3.5980847,3.5980847 0 0 0 -3.11523,-5.396484 H 260 Z"
        ...
        triangle.rotate(angle_deg, center=(rect_cx, rect_cy))
