...
num_copies = 37                     # How many rectangles to create
...
for j in range(num_copies + 1):
    ...
    output_svg_filename = f'pictures/boiler_{j}.svg'
    output_png_filename = f'pictures/boiler_{j}.png'
